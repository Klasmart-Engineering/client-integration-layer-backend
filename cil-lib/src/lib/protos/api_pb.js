...
proto.cil_onboarding.api.Link.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    addUserToSchool: (f = msg.getAddUserToSchool()) && proto.cil_onboarding.api.AddUsersToSchool.toObject(includeInstance, f),
...
/**
 * optional AddUsersToSchool add_user_to_school = 3;
 * @return {?proto.cil_onboarding.api.AddUsersToSchool}
 */
